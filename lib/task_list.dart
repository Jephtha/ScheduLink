...
List<TempTask> getTaskList(){
  final task1 = TempTask("Final Project","CS1000","Finish final project",DateTime(2023,12,10,23,59),3,false);
  final task2 = TempTask("Review Notes","Math1000","Review notes for exam",DateTime(2023,12,08,11,59),1,false);
  final task3 = TempTask("Online Quiz","CS1001","Do online quiz",DateTime(2023,12,08,23,59),2,false);
